                        ...
                        std::vector<double>& statesmeas)
{
    ...
    {
        // phi(t+1) = phi(t) + sample_time*r_rate(t)
        commandstruct.control_attitude_vec[2] = statesmeas.at(6) + nmpc_inp_struct.sample_time * acadostruct.u[2];
        //        commandstruct.control_attitude_vec[2] = acadostruct.x[6];
    }
    else
        commandstruct.control_attitude_vec[2] = nmpc_inp_struct.ref_yaw;
