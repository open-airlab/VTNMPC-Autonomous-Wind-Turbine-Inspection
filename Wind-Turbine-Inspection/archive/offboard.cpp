...
int main(int argc, char **argv)
{
   ...
   // transformStamped_.transform.rotation.w = quaternion_.w();
    pose.pose.position.x = -750/100;
    pose.pose.position.y = 8500/100;
    pose.pose.position.z = 2000/50;
    ...
    //pose.pose.orientation.y = sin(yawa*(3.14/180));
    //pose.pose.orientation.z = cos(yawa*(3.14/180));
