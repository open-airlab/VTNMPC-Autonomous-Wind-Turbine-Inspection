...
// required float time_msec = 1;
bool Range::has_time_msec() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void Range::set_has_time_msec() {
  _has_bits_[0] |= 0x00000001u;
}
void Range::clear_has_time_msec() {
  _has_bits_[0] &= ~0x00000001u;
}
void Range::clear_time_msec() {
  time_msec_ = 0;
  clear_has_time_msec();
}
 float Range::time_msec() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.Range.time_msec)
  return time_msec_;
}
 void Range::set_time_msec(float value) {
  set_has_time_msec();
  time_msec_ = value;
