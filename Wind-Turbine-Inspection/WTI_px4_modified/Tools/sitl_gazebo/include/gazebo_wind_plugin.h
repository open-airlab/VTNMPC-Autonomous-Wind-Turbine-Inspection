...
static const ignition::math::Vector3d kDefaultWindDirectionMean =
    ignition::math::Vector3d(1, 0, 0);
static const ignition::math::Vector3d kDefaultWindGustDirectionMean =
...
public:
  GazeboWindPlugin()
      : WorldPlugin(), namespace_(kDefaultNamespace),
        ...
        frame_id_(kDefaultFrameId), pub_interval_(0.5), node_handle_(NULL) {}
