...
void GazeboMotorFailure::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    ...
    if (_sdf->HasElement("robotNamespace"))
        ...
        gzerr << "[gazebo_motor_failure_plugin] Please specify a robotNamespace.\n";
    ...
    getSdfParam<std::string>(
        _sdf, "MotorFailureNumPubTopic", motor_failure_num_pub_topic_, motor_failure_num_pub_topic_);
    ...
    ros::SubscribeOptions so =
        ros::SubscribeOptions::create<std_msgs::Int32>(ROS_motor_num_sub_topic_,
                                                       1,
