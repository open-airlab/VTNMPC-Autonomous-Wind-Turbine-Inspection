...
namespace airlib
{
    ...
    protected: //static utility functions for derived classes to use
        ...
        {
            //set up arm lengths
            //dimensions are for DJI M300 frame: https://www.dji.com/dk/matrice-100/specs
            params.rotor_count = 4;
            std::vector<real_T> arm_lengths(params.rotor_count, 0.260f);

            //set up mass
            //this has to be between max_thrust*rotor_count/10 (6.8kg using parameters in RotorParams.hpp) and (idle throttle percentage)*max_thrust*rotor_count/10 (3.4kg using default parameters and SimpleFlight)
            ...
            // Motors specs: https://www.dji.com/dk/e800/info
            real_T motor_assembly_weight = 0.106f; //weight for motor
            ...
            params.body_box.x() = 0.230f;
            params.body_box.y() = 0.160f;
            params.body_box.z() = 0.126f;
            real_T rotor_z = 0.034f;
