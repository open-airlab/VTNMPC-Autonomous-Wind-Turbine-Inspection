...
private:
    ...
    public:
        ...
        nav_msgs::Odometry curr_gt_odom;
    ...
    nav_msgs::Odometry get_odom_msg_from_kinematics_state(msr::airlib::Kinematics::State kinematics_state) const;
...
private:
    ...
    nav_msgs::Odometry get_odom_msg_from_kinematic_state(const Kinematics &kinematics_state) const;
};