...
class Odometry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nav_msgs.msgs.Odometry) */ {
 public:
  ...
  ::google::protobuf::int32 usec() const;
  void set_usec(::google::protobuf::int32 value);
  ...
  float twist_covariance(int index) const;
  void set_twist_covariance(int index, float value);
  void add_twist_covariance(float value);
  const ::google::protobuf::RepeatedField< float >&
