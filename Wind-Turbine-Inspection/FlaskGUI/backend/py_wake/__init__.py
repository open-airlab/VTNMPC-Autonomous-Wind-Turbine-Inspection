...
from backend.py_wake.flow_map import HorizontalGrid, XYGrid, YZGrid
from backend.py_wake.wind_farm_models.wind_farm_model import WindFarmModel
from backend.py_wake.deficit_models.deficit_model import DeficitModel


plugins = {
    entry_point.name: entry_point.load()
    for entry_point
    in pkg_resources.iter_entry_points('backend.py_wake.plugins')
}
