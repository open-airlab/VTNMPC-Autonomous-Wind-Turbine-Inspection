...
import warnings
import inspect
from backend.py_wake.wind_turbines.power_ct_functions import PowerCtFunctionList, PowerCtTabular, SimpleYawModel, CubePowerSimpleCt
import xarray as xr
...
class WindTurbines():
    ...
    def __new__(cls, *args, **kwargs):
        from backend.py_wake.wind_turbines.wind_turbines_deprecated import DeprecatedWindTurbines
        if cls != WindTurbines:
...
def main():
    if __name__ == '__main__':
        import os.path
        import matplotlib.pyplot as plt
        from backend.py_wake.examples.data import wtg_path
