...
from backend.py_wake.utils.gradients import fd
from scipy.interpolate.fitpack2 import UnivariateSpline
from autograd.numpy.numpy_boxes import ArrayBox
from backend.py_wake.wind_turbines.wind_turbine_functions import WindTurbineFunction, FunctionSurrogates, \
    WindTurbineFunctionList
from backend.py_wake.utils.check_input import check_input
...
class PowerCtNDTabular(PowerCtFunction):
    ...
    def _power_ct(self, ws, run_only, **kwargs):
        ...
        args = args.clip(min=0.1, max=29.6)
        try:
