...
from backend.py_wake.deficit_models import BlockageDeficitModel
...
def main():
    if __name__ == '__main__':
        from backend.py_wake.examples.data.iea37._iea37 import IEA37Site
        from backend.py_wake.examples.data.iea37._iea37 import IEA37_WindTurbines
        from backend.py_wake.site._site import UniformSite
        from backend.py_wake.wind_turbines import OneTypeWindTurbines
        from backend.py_wake.superposition_models import LinearSum
        from backend.py_wake.wind_farm_models import All2AllIterative
        from backend.py_wake.deficit_models.no_wake import NoWakeDeficit
        from backend.py_wake.rotor_avg_models import RotorCenter
        from backend.py_wake.deficit_models.vortexcylinder import VortexCylinder
        from backend.py_wake.deficit_models.vortexdipole import VortexDipole
        import matplotlib.pyplot as plt
        from backend.py_wake import HorizontalGrid
