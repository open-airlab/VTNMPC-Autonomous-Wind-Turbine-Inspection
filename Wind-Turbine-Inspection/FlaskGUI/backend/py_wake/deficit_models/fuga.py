...
import numpy as np
from backend.py_wake.deficit_models.deficit_model import WakeDeficitModel, BlockageDeficitModel
...
from backend.py_wake.utils.fuga_utils import FugaUtils
from backend.py_wake.wind_farm_models.engineering_models import PropagateDownwind, All2AllIterative
...
class FugaDeficit(WakeDeficitModel, BlockageDeficitModel, FugaUtils):
    ...
    def __init__(self, LUT_path, remove_wriggles=False,
                 method='linear'):
        """
        Parameters
        ----------
