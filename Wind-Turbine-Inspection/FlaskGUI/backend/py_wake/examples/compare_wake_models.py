def main():
    if __name__ == '__main__':
        ...
        from backend.py_wake import IEA37SimpleBastankhahGaussian, Fuga
        import backend.py_wake
        import os
        import matplotlib.pyplot as plt
        from backend.py_wake.examples.data.hornsrev1 import HornsrevV80, Hornsrev1Site
        from backend.py_wake.examples.data.iea37._iea37 import IEA37Site

        LUT_path = os.path.dirname(backend.py_wake.__file__) + '/tests/test_files/fuga/2MW/Z0=0.03000000Zi=00401Zeta0=0.00E+00/'
