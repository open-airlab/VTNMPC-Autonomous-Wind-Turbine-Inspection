from backend.py_wake.wind_turbines import WindTurbine
import numpy as np
from pathlib import Path
from backend.py_wake.utils.tensorflow_surrogate_utils import TensorflowSurrogate
import inspect
from backend.py_wake.wind_turbines.power_ct_functions import PowerCtSurrogate
from backend.py_wake.wind_turbines.wind_turbine_functions import FunctionSurrogates
from backend.py_wake.examples.data import example_data_path
from backend.py_wake.utils.model_utils import fix_shape
...
def main():
    if __name__ == '__main__':
        from backend.py_wake.examples.data.hornsrev1 import Hornsrev1Site
        from backend.py_wake.turbulence_models.stf import STF2017TurbulenceModel
        from backend.py_wake import NOJ
