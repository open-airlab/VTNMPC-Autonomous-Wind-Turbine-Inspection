...
from backend.py_wake.examples.data.iea37.iea37_reader import read_iea37_windturbine, read_iea37_windturbine_deprecated
from backend.py_wake.examples.data.iea37 import iea37_path
from backend.py_wake.examples.data.iea37.iea37_aepcalc import getTurbLocYAML,\
...
from backend.py_wake.wind_turbines.wind_turbines_deprecated import DeprecatedOneTypeWindTurbines
...
class IEA37Site(UniformSite):
    def __init__(self, n_wt, ti=.075, shear=None):
        ...
        from backend.py_wake.examples.data.iea37.iea37_reader import \
