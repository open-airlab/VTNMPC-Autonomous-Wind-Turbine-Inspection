...
from backend.py_wake.superposition_models import AddedTurbulenceSuperpositionModel, LinearSum, SqrMaxSum, MaxSum
...
# from backend.py_wake.super_position_models import LinearSum, SqrMaxSum, MaxSum
LinearSum = LinearSum
SqrMaxSum = SqrMaxSum
MaxSum = MaxSum
